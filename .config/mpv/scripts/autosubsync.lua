...
local config = {
    subsync_path = "/home/seba/.local/bin/ffsubsync"  -- Replace the following line if the location of ffsubsync differs from the defaults
}
...
mp.add_key_binding("Ctrl+n", "auto_sync_subs", sync_sub_fn)
