...
description: Generate .NET Core applications, build minimal APIs, and implement cloud-native microservices. Use when working with C# files (*.cs), .NET projects (*.csproj), or when the user mentions ASP.NET, Entity Framework, or .NET development.
---
